...
export const restrictedMockTestStages = [
  {
    ...
    tasks: [
      { id: "s1_rt", name: "Right turn giving way (1 lane each way)", speed: "≤60" },
      { id: "s1_lt", name: "Left turn giving way (1 lane each way)", speed: "≤60" },
      { id: "s1_lcr", name: "Lane change right", speed: "≤60" },
      { id: "s1_lcl", name: "Lane change left", speed: "≤60" },
      { id: "s1_rpp", name: "Reverse parallel park", speed: "Low / kerbside" },
      { id: "s1_3pt", name: "Three-point turn (if used instead of RPP)", speed: "Low / kerbside" },
      { id: "s1_extra", name: "Extra task / variation", speed: "Custom" },
    ],
  },
  {
    id: "stage2",
    ...
    tasks: [
      { id: "s2_rt1", name: "Right turn giving way (1 lane each way)", speed: "50–60" },
      { id: "s2_rt2", name: "Right turn giving way (2 lanes each way)", speed: "50–60" },
      { id: "s2_rtOncoming1", name: "Right turn across 1 lane oncoming", speed: "50–60" },
      { id: "s2_rtOncoming2", name: "Right turn across 2 lanes oncoming", speed: "50–60" },
      { id: "s2_lt1", name: "Left turn giving way (1 lane each way)", speed: "50–60" },
      { id: "s2_lt2", name: "Left turn giving way (2 lanes each way)", speed: "50–60" },
      { id: "s2_ltPrio", name: "Left turn with priority", speed: "50–60" },
      { id: "s2_lcr", name: "Lane change right", speed: "50–80" },
      { id: "s2_lcl", name: "Lane change left", speed: "50–80" },
      { id: "s2_lcrTurn", name: "Lane change right for upcoming turn", speed: "50–80" },
      { id: "s2_lclTurn", name: "Lane change left for upcoming turn", speed: "50–80" },
      { id: "s2_merge", name: "Merge lanes", speed: "70–100" },
      { id: "s2_stMed", name: "Straight drive – medium speed", speed: "60–80" },
      { id: "s2_stArt", name: "Straight drive – arterial road / 100–110", speed: "80–110" },
      { id: "s2_rbRight", name: "Right turn at roundabout", speed: "Varies" },
      { id: "s2_rbStraight", name: "Straight through at roundabout", speed: "Varies" },
      { id: "s2_extra1", name: "Extra complex task / variation 1", speed: "Custom" },
      { id: "s2_extra2", name: "Extra complex task / variation 2", speed: "Custom" },
    ],
  },
] as const;
